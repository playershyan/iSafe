  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8 md:py-12">
      ...
      <div className="space-y-6 text-base leading-relaxed text-gray-700">
        <section>
          <h2 className="mb-3 text-xl font-bold text-gray-900">{t('purpose')}</h2>
          <p>
        ...
        <section>
          <h2 className="mb-3 text-xl font-bold text-gray-900">{t('acceptableUse')}</h2>
          <p>
        ...
        <section>
          <h2 className="mb-3 text-xl font-bold text-gray-900">{t('accuracy')}</h2>
          <p>
        ...
        <section>
          <h2 className="mb-3 text-xl font-bold text-gray-900">{t('noWarranty')}</h2>
          <p>
        ...
        <section>
          <h2 className="mb-3 text-xl font-bold text-gray-900">{t('limitation')}</h2>
          <p>
        ...
        <section>
          <h2 className="mb-3 text-xl font-bold text-gray-900">{t('changes')}</h2>
          <p>
